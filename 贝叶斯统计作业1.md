...
数学期望：
$$E(X) = \int_{a}^{b} x \cdot f(x) \, dx$$ $$= \int_{a}^{b} x \cdot \frac{1}{b - a} \, dx$$ $$= \frac{1}{b - a} \cdot \left[\frac{x^2}{2}\right]_{a}^{b}$$ $$= \frac{1}{b - a} \cdot \left(\frac{b^2}{2} - \frac{a^2}{2}\right)$$ $$= \frac{b + a}{2}$$
方差：
