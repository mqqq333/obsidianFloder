...
为了确定即时的人类-AI合作是否能够超越传统的（尽管很少）培训方法来提高表达的同情心，两组参与者在研究开始前都接受了初步的同情心培训。在没有AI的情况下，人类同伴支持者面对一个空白的聊天框来撰写他们的回应，由于他们通常没有接受过关于最佳实践（如同情心）的培训，因此很少进行高度同情性的对话。而AI反馈代理（HAILEY）则在同伴支持者撰写回应时提供即时的AI反馈。HAILEY会建议可以对回应进行的修改，以使其更具同情心，这些建议包括可以插入的新句子和用更具同情心的对应句子替换当前句子的选项。参与者可以通过点击“插入”和“替换”按钮接受这些建议，并继续编辑回应，或者根据需要获取更多反馈。
# 研究结果
